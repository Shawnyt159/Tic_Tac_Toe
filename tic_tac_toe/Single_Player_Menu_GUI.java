...
public class Single_Player_Menu_GUI {
	 ...
	 */
	public Single_Player_Menu_GUI(JFrame previous_frame) {
	...
	private void initialize(JFrame previous_frame) {
		...
		x_or_o_comboBox.setBounds(136, 81, 65, 30);
		option_panel.add(x_or_o_comboBox);
		
		JLabel x_or_o_label = new JLabel("Choose X or O:");
		x_or_o_label.setFont(new Font("Times New Roman", Font.BOLD, 15));
		x_or_o_label.setBounds(10, 85, 116, 13);
		option_panel.add(x_or_o_label);
		
		JLabel ai_logic_level_label = new JLabel("Hardness:");
		ai_logic_level_label.setFont(new Font("Times New Roman", Font.BOLD, 15));
		ai_logic_level_label.setBounds(10, 127, 116, 13);
		option_panel.add(ai_logic_level_label);
		
		JComboBox<String> ai_logic_level_comboBox = new JComboBox<String>();
		ai_logic_level_comboBox.setModel(new DefaultComboBoxModel(new String[] {"EASY", "MEDIUM", "HARD"}));
		ai_logic_level_comboBox.setFont(new Font("Times New Roman", Font.BOLD, 15));
		ai_logic_level_comboBox.setBounds(136, 121, 132, 30);
		option_panel.add(ai_logic_level_comboBox);
		...
		play_button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				tic_tac_toe_board new_game = new tic_tac_toe_board(previous_frame, x_or_o_comboBox.getSelectedIndex(), ai_logic_level_comboBox.getSelectedIndex());
